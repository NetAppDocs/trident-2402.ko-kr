...
TIP: Kubernetes 클러스터의 Astra Trident 아키텍처에 대한 자세한 내용은 link:../trident-get-started/architecture.html["Astra Trident 아키텍처"]을 참조하십시오.
