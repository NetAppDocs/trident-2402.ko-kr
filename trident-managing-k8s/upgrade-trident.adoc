...
* 4개 릴리스 기간 외의 버전에서 업그레이드하는 경우 여러 단계를 거쳐 업그레이드하십시오. 업그레이드하려는 이전 버전의 업그레이드 지침을 사용하여 4개 릴리스 기간에 맞는 최신 릴리스로 업그레이드하십시오. 예를 들어 22.01 버전을 실행 중이고 24.02으로 업그레이드하려는 경우:
+
